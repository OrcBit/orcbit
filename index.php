...
<section class="maincontent">
    <div id="content">
        <div class="wrapper">
    <h1 class="header-title"> OrcBit Official Website </h1>
    <img class="bannerpic" src="images/live-banner-legacy.jpg">
    <h2 class="header-utitle">Welcome to the official OrcBit website</h2>
    <h3>My classic WoW Guide Site</h3>
